...
\addplot [orange,mark=diamond] table [x={threads}, y={NonBlockingTorontoBSTMap}]
{results/trees-i1000000-u100.log}; 
\addplot [magenta,mark=+] table [x={threads}, y={BinaryTree}]
{results/tran-i1000000-u100.log};
