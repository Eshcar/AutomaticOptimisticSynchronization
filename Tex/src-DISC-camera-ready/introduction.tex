...
In the full version of the paper~\cite{fullversion} we show that our transformation preserves the external behavior (e.g., linearizability, serializability, and deadlock-freedom) of the original lock-based code; %formal proofs appear in Appendix~\ref{sec:formal-proof}.
