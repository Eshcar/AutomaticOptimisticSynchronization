...
Since the read only prefix has no side effects we can sandbox it by catching exceptions and infinite loops, and defer validation to the end of the phase.
