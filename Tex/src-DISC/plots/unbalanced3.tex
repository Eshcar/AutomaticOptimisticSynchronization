...
{results/trees-i1000000-u100.log};
\addplot [black,mark=square] table [x={threads}, y={OptLockRemovalTree}]
{results/trees-i1000000-u100.log};
\end{axis}
\end{tikzpicture}
\begin{tikzpicture}
...
\addplot [blues4,mark=x] table [x={threads}, y={DominationLockingTree}]
{results/trees-i1000000-u50.log};
\addplot [black,mark=square] table [x={threads}, y={OptLockRemovalTree}]{results/trees-i1000000-u50.log};
\end{axis}
\end{tikzpicture}
\begin{tikzpicture}
\begin{axis}[mystyle,
