...
\def\denseformat{
\setlength{\textheight}{9.8in} \setlength{\textwidth}{6.8in}
\setlength{\oddsidemargin}{-0.3in} \setlength{\headsep}{0pt}
\setlength{\topmargin}{-34pt} \setlength{\columnsep}{0.375in}
}
\denseformat
...
\bigskip\bigskip
\noindent
Corresponding author: Maya Arbel mayaarl@cs.technion.ac.il\\
\noindent
{\bf
