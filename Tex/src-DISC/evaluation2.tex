...
\Idit{Can we say the following sentence?} In our experiments, the code \emph{never} incurred a spurious exception or timeout due to
...
The throughput of our read-only operations is \Idit{how much?} lower than that achieved by the best-in-class. 
...
In  workloads that include update operations, our solution is  \Idit{how much?} slower.
