...
mix of insert and delete operations (50\% each). \eshcar{what about a workload that includes only 100\% range
queries?} We experiment with small
ranges, where the size of each query is a number selected uniform at random
from $[10,20]$.  \eshcar{ what about medium/big size scans?}. 
