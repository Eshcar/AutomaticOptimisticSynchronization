...
protocol took place. \maya{If the validation fails the operation 
restarts, to avoid live-locks if an operation restarts 
count pass some set threshold it falls back to pessimistic 
execution.} 
