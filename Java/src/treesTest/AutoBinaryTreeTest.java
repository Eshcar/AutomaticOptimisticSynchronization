...
public class AutoBinaryTreeTest {
	@Test
	public void testSequential() {
		System.out.println("Starting AutoSimpleBinaryTreeTest - TestSequential");
		Map<Integer,Integer> tree = new AutoBinaryTree<Integer,Integer>(-1,50);
	...
	public void multiTest1() {
		...
		int numOps =2000000; 
		Map<Integer,Integer> tree = new AutoBinaryTree<Integer,Integer>(-1,maxKey);
