...
import trees.Map;
import trees.skipList.SingleNodeDominationLockingSL;

public class SingleNodeDominationLockingSLTest {
	@Test
	public void test() {
		System.out.println("Starting BinaryTreeTest - TestSequential");
		Map<Integer,Integer> tree = new SingleNodeDominationLockingSL<Integer,Integer>(50,Integer.MIN_VALUE,Integer.MAX_VALUE);
	...
	public void multiTest1() {
		...
		int numOps =2000000; 
		Map<Integer,Integer> tree = new SingleNodeDominationLockingSL<Integer,Integer>(maxKey,-1,maxKey);
