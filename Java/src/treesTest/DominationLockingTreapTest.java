...
import trees.Map;
import trees.localVersion.DominationLockingTreap;

public class DominationLockingTreapTest {
	@Test
	public void test() {
		System.out.println("Starting AutoSimpleTreapTest - TestSequential");
		Map<Integer,Integer> tree = new DominationLockingTreap<Integer,Integer>();
