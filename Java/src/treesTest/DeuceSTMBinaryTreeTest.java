...
import trees.DeuceSTMBinaryTree;
import trees.Map;


public class DeuceSTMBinaryTreeTest {
	
	@Test
	public void testSequential() {
		System.out.println("Starting AutoSimpleBinaryTreeTest - TestSequential");
		Map<Integer,Integer> tree = new DeuceSTMBinaryTree<Integer,Integer>(-1,50);
	...
	public void multiTest1() {
		...
		int numOps =2000000; 
		Map<Integer,Integer> tree = new DeuceSTMBinaryTree<Integer,Integer>(-1,maxKey);
