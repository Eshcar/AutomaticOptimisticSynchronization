...
/*
 * TODO: do we need final/volatile modifiers ?
 * 
 * */
...
public class BinaryTree<K, V> implements Map<K, V> {
	...
	public BinaryTree(final K min, final K max) {	
		this.min = min;
		this.root = new Node<K, V>(max,null); 
        this.comparator = null;        
    }

    public BinaryTree(final K min, final K max, final Comparator<? super K> comparator) {
    	this.min = min;
    	this.root = new Node<K, V>(max,null); 
