...
public class GlobalLockBinaryTree<K, V> implements Map<K, V> {
	
	private final Comparator<? super K> comparator;
	private final K min; 
	private final Node<K, V> root; 
	
	public GlobalLockBinaryTree(final K min, final K max) {	
		this.min = min;
		this.root = new Node<K, V>(max,null); 
        this.comparator = null;        
    }

    public GlobalLockBinaryTree(final K min, final K max, final Comparator<? super K> comparator) {
    	this.min = min;
    	this.root = new Node<K, V>(max,null); 
