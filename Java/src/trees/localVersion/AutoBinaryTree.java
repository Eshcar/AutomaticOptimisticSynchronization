...
public class AutoBinaryTree<K,V> implements Map<K,V>{
	...
	public AutoBinaryTree(final K min, final K max) {	
		this.min = min;
		this.root = new Node<K, V>(max,null); 
        this.comparator = null;   
    }

    public AutoBinaryTree(final K min, final K max, final Comparator<K> comparator) {
    	this.min = min;
    	this.root = new Node<K, V>(max,null); 
